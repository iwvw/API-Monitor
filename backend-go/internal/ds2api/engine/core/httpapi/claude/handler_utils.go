...
// buildClaudeToolPromptParts splits the Claude tool prompt into the tool
// descriptions/schemas block and the unified tool-call format spec. The format
// spec is placed at the end of the message sequence (see
// appendClaudeToolCallFormatSpec) while the descriptions stay in the system
// prompt.
func buildClaudeToolPromptParts(tools []any) (string, string) {
