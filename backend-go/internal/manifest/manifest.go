...
func buildRoutes() []Route {
	return []Route{
		...
		{Prefix: "/api/aiagent/users/{id}/reset-password", Module: "aiagent", Owner: OwnerGo, Auth: AuthPublic, ResponseMode: ResponseJSON, Description: "AI Agent user password reset (admin)", MatchMode: MatchPattern},
		{Prefix: "/api/aiagent/users/{id}/instances", Module: "aiagent", Owner: OwnerGo, Auth: AuthPublic, ResponseMode: ResponseJSON, Description: "AI Agent user instance grants (admin)", MatchMode: MatchPattern},
		{Prefix: "/api/aiagent/users/{id}", Module: "aiagent", Owner: OwnerGo, Auth: AuthPublic, ResponseMode: ResponseJSON, Description: "AI Agent user update/delete (admin)", MatchMode: MatchPattern},
		{Prefix: "/api/aiagent/users", Module: "aiagent", Owner: OwnerGo, Auth: AuthPublic, ResponseMode: ResponseJSON, Description: "AI Agent user list/create (admin)", MatchMode: MatchExact},
		...
		{Prefix: "/api/aiagent/instances/{id}", Module: "aiagent", Owner: OwnerGo, Auth: AuthPublic, ResponseMode: ResponseJSON, Description: "AI Agent instance update/delete", MatchMode: MatchPattern},
		{Prefix: "/api/aiagent/instances", Module: "aiagent", Owner: OwnerGo, Auth: AuthPublic, ResponseMode: ResponseJSON, Description: "AI Agent instance list/create", MatchMode: MatchExact},
