...
var apiDocSeeds = []apiDocSeed{
	...
	{Route: manifest.Route{Prefix: "/api/koyeb/services/{serviceId}/logs/tail", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseStream, Description: "Koyeb service logs tail stream", MatchMode: manifest.MatchPattern}},
	...
	{Route: manifest.Route{Prefix: "/api/koyeb/services", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb service create", MatchMode: manifest.MatchExact}},
	{Route: manifest.Route{Prefix: "/api/koyeb/services/{serviceId}/update", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb service config/image update", MatchMode: manifest.MatchPattern}},
	{Route: manifest.Route{Prefix: "/api/koyeb/services/{serviceId}/deployments", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb service deployment list", MatchMode: manifest.MatchPattern}},
	{Route: manifest.Route{Prefix: "/api/koyeb/deployments/{deploymentId}/cancel", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb deployment cancel", MatchMode: manifest.MatchPattern}},
	{Route: manifest.Route{Prefix: "/api/koyeb/services/{serviceId}/scale", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb service manual scaling read/update/delete", MatchMode: manifest.MatchPattern}},
	{Route: manifest.Route{Prefix: "/api/koyeb/apps/{appId}/pause", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb app pause", MatchMode: manifest.MatchPattern}},
	{Route: manifest.Route{Prefix: "/api/koyeb/apps/{appId}/resume", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb app resume", MatchMode: manifest.MatchPattern}},
	{Route: manifest.Route{Prefix: "/api/koyeb/domains", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb domain list/create", MatchMode: manifest.MatchExact}},
	{Route: manifest.Route{Prefix: "/api/koyeb/domains/{domainId}", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb domain delete", MatchMode: manifest.MatchPattern}},
	{Route: manifest.Route{Prefix: "/api/koyeb/domains/{domainId}/refresh", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb domain verify refresh", MatchMode: manifest.MatchPattern}},
	{Route: manifest.Route{Prefix: "/api/koyeb/secrets", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb secret list/create", MatchMode: manifest.MatchExact}},
	{Route: manifest.Route{Prefix: "/api/koyeb/secrets/{secretId}", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb secret delete", MatchMode: manifest.MatchPattern}},
	{Route: manifest.Route{Prefix: "/api/koyeb/secrets/{secretId}/update", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb secret value update", MatchMode: manifest.MatchPattern}},
	{Route: manifest.Route{Prefix: "/api/koyeb/catalog/instances", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb instance catalog", MatchMode: manifest.MatchExact}},
	{Route: manifest.Route{Prefix: "/api/koyeb/catalog/regions", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb region catalog", MatchMode: manifest.MatchExact}},
	{Route: manifest.Route{Prefix: "/api/koyeb/usage/details", Module: "koyeb", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Koyeb usage details", MatchMode: manifest.MatchExact}},
	...
	// ---- Docker Hub（镜像仓库浏览与账号凭据管理）----
	{Route: manifest.Route{Prefix: "/api/dockerhub", Module: "dockerhub", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Docker Hub account and image repository browsing"}},
	{Route: manifest.Route{Prefix: "/api/dockerhub/accounts", Module: "dockerhub", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Docker Hub account list/create", MatchMode: manifest.MatchExact},
		Docs: apiRouteDocs{Methods: []string{"GET", "POST"}}},
	{Route: manifest.Route{Prefix: "/api/dockerhub/accounts/{accountId}", Module: "dockerhub", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Docker Hub account delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/dockerhub/accounts/{accountId}/verify", Module: "dockerhub", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Docker Hub account token verify", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}}},
	{Route: manifest.Route{Prefix: "/api/dockerhub/accounts/{accountId}/repositories", Module: "dockerhub", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Docker Hub account repositories", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/dockerhub/search", Module: "dockerhub", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Docker Hub repository search", MatchMode: manifest.MatchExact},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/dockerhub/repositories/{namespace}/{name}", Module: "dockerhub", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Docker Hub repository detail", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/dockerhub/repositories/{namespace}/{name}/tags", Module: "dockerhub", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Docker Hub repository tags", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	...
	// ---- GCP 全模块 ----
	{Route: manifest.Route{Prefix: "/api/gcp/accounts", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP accounts list/create", MatchMode: manifest.MatchExact},
		Docs: apiRouteDocs{Methods: []string{"GET", "POST"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP account update/delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"PUT", "DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/verify", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP account verify", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP projects list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/default-project", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP default project set", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"PUT"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/instances", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP instances list/create", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET", "POST"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/instances/{iid}", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP instance detail/delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET", "DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/instances/{iid}/actions", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP instance lifecycle action", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/instances/{iid}/labels", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP instance labels edit", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/disks", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP disks list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/disks/{diskName}", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP disk detail/delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET", "DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/disks/{diskName}/resize", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP disk resize", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/disks/{diskName}/snapshot", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP disk snapshot", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/zones", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP zones list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/machine-types", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP machine types list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/images", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP images list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/subnetworks", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP subnetworks list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/firewalls", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP firewalls list/create", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET", "POST"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/firewalls/{ruleName}", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP firewall update/delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"PATCH", "DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/addresses", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP static addresses list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/buckets", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP buckets list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/buckets", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP bucket create", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/buckets/{bucket}", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP bucket delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/buckets/{bucket}/objects", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP objects list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/buckets/{bucket}/objects/{object}/download-url", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP object download url", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/buckets/{bucket}/objects/{object}", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP object delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/billing-accounts", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP billing accounts list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/billing-info", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP project billing info", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/projects/{projectId}/model-usage", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP Vertex AI model usage from Cloud Monitoring", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}, QueryParams: []apiDocParameter{
			{Name: "days", In: "query", Required: false, Description: "查询天数，默认 30，上限 90"},
		}}},
	{Route: manifest.Route{Prefix: "/api/gcp/accounts/{id}/billing-accounts/{billingAccountId}/budgets", Module: "gcp", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "GCP budgets list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},

	// ---- 华为云 全模块 ----
	{Route: manifest.Route{Prefix: "/api/huawei/export/accounts", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud account export", MatchMode: manifest.MatchExact},
		Docs: apiRouteDocs{Methods: []string{"GET"}, Detail: "导出全部华为云账号（含 AK/SK/SSH 凭据明文，供迁移备份）"}},
	{Route: manifest.Route{Prefix: "/api/huawei/import/accounts", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud account import", MatchMode: manifest.MatchExact},
		Docs: apiRouteDocs{Methods: []string{"POST"}, Detail: "导入账号清单，可选 overwrite 覆盖全表", RequestExample: map[string]interface{}{"accounts": []interface{}{map[string]interface{}{"name": "prod", "accessKeyId": "<ACCESS_KEY_ID>", "secretAccessKey": "<SECRET_KEY>", "sshUser": "root", "sshPort": 22}}, "overwrite": false}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud accounts list/create", MatchMode: manifest.MatchExact},
		Docs: apiRouteDocs{Methods: []string{"GET", "POST"}, Detail: "列出华为云账号，或新增一个（AK/SK + 站点）", RequestExample: map[string]interface{}{"name": "prod", "site": "cn", "accessKeyId": "<ACCESS_KEY_ID>", "secretAccessKey": "<SECRET_KEY>"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud account update/delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"PUT", "DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/verify", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud account verify", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}, Detail: "验证账号（AK/SK → IAM projects）"}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud project list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/ssh", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseStream, Description: "Huawei Cloud SSH terminal websocket", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}, Detail: "WebSocket SSH 终端直连实例公网 IP", QueryParams: []apiDocParameter{
			{Name: "host", In: "query", Required: true, Description: "实例公网 IP"},
			{Name: "user", In: "query", Required: false, Description: "SSH 用户，默认账号配置或 root"},
			{Name: "port", In: "query", Required: false, Description: "SSH 端口，默认账号配置或 22"},
		}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/defaults", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud default region/project update", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"PUT"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/flexus-instances", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud Flexus L instance list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}, Detail: "Flexus L 套餐列表（RMS），含云主机状态/IP/到期/流量包"}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/flexus-instances/{instanceId}", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud Flexus L instance rename", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"PUT"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/flexus-instances/{instanceId}/actions", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud Flexus L instance action", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}, RequestExample: map[string]interface{}{"action": "start|stop|reboot"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/flexus-instances/{instanceId}/reset-password", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud Flexus L instance reset password", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}, RequestExample: map[string]interface{}{"newPassword": "<PASSWORD>"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/instances", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud ECS instance list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}, Detail: "ECS 实例列表，projectId=all 时跨区域聚合"}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/instances/actions", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud ECS batch action", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}, RequestExample: map[string]interface{}{"action": "start|stop|reboot", "serverIds": []string{"<SERVER_ID>"}}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/instances/{instanceId}", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud ECS instance detail/update/delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET", "PUT", "DELETE"}, QueryParams: []apiDocParameter{
			{Name: "deletePublicIp", In: "query", Required: false, Description: "删除时是否释放公网 IP"},
			{Name: "deleteVolume", In: "query", Required: false, Description: "删除时是否删除云硬盘"},
		}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/instances/{instanceId}/reset-password", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud ECS reset password", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"POST"}, RequestExample: map[string]interface{}{"newPassword": "<PASSWORD>"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/dns/zones", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud DNS zone list/create", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET", "POST"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/dns/zones/{zoneId}", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud DNS zone detail/delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET", "DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/dns/zones/{zoneId}/recordsets", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud DNS recordsets", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET", "POST"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/dns/zones/{zoneId}/recordsets/{recordsetId}", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud DNS recordset update/delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"PUT", "DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/eips", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud EIP list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/eips/{eipId}/associate", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud EIP associate", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"PUT"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/eips/{eipId}/disassociate", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud EIP disassociate", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"PUT"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/vpcs", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud VPC list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/security-groups", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud security group list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/buckets", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud OBS bucket list/create", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET", "POST"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/buckets/{bucket}", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud OBS bucket delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/buckets/{bucket}/objects", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud OBS object list/upload", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET", "POST"}, QueryParams: []apiDocParameter{
			{Name: "prefix", In: "query", Required: false, Description: "对象前缀过滤"},
			{Name: "marker", In: "query", Required: false, Description: "分页游标"},
			{Name: "region", In: "query", Required: false, Description: "桶所在区域"},
			{Name: "name", In: "query", Required: true, Description: "上传对象名（POST）"},
		}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/projects/{projectId}/buckets/{bucket}/objects/{object}", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud OBS object delete", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"DELETE"}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/billing/overview", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud billing overview", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}, QueryParams: []apiDocParameter{
			{Name: "cycle", In: "query", Required: false, Description: "账单月份 YYYY-MM，默认当前月"},
		}}},
	{Route: manifest.Route{Prefix: "/api/huawei/accounts/{id}/billing/free-resources", Module: "huawei", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "Huawei Cloud free resource usage", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}, Detail: "聚合账号下 Flexus L 流量包用量"}},
	...
	{Route: manifest.Route{Prefix: "/api/m365/accounts/{id}/licenses/skus", Module: "m365", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "M365 license SKUs list", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}}},
	{Route: manifest.Route{Prefix: "/api/m365/accounts/{id}/usage/onedrive", Module: "m365", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "M365 OneDrive usage by user", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}, Detail: "按用户查询 OneDrive 已用/总容量（userIds 传入用户 ID 列表，并发受限）"}},
	{Route: manifest.Route{Prefix: "/api/m365/accounts/{id}/users/{uid}/drive-quota", Module: "m365", Owner: manifest.OwnerGo, Auth: manifest.AuthSession, ResponseMode: manifest.ResponseJSON, Description: "M365 user OneDrive quota", MatchMode: manifest.MatchPattern},
		Docs: apiRouteDocs{Methods: []string{"GET"}, Detail: "读取单个用户 OneDrive 实时容量详情（未开通时返回 provisioned=false）"}},
