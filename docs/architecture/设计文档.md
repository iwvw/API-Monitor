...
API Monitor 是一个单体模块化的 API 管理、云服务管理与主机监控面板。当前技术主线是 **React 19 + Kumo 2.13.2 + Zustand + Go Manifest Backend + SQLite + Rust Agent**。
...
- 允许例外必须记录在 `docs/standards/重构验证与例外清单.md`。
