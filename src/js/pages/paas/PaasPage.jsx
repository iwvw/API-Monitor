...
import {
  MAX_PAAS_REFRESH_INTERVAL_SEC,
  normalizeRefreshIntervalInputSec,
  normalizeStoredRefreshIntervalSec,
  normalizeFlyImageForInput,
} from './constants.js';
import { formatRegion } from './utils.js';
import { tabs } from './tabs.jsx';
import AddKoyebAccountDialog from './AddKoyebAccountDialog.jsx';
import AddFlyAccountDialog from './AddFlyAccountDialog.jsx';
import KoyebConfigDialog from './KoyebConfigDialog.jsx';
import KoyebDeploymentsDialog from './KoyebDeploymentsDialog.jsx';
import KoyebScaleDialog from './KoyebScaleDialog.jsx';
import KoyebDomainsDialog from './KoyebDomainsDialog.jsx';
import KoyebSecretsDialog from './KoyebSecretsDialog.jsx';
...
function PaasPage() {
  ...
  return (
    <div className="flex w-full min-w-0 flex-col gap-3 cq-sm:gap-4">
      ...
      <AddKoyebAccountDialog
        showAddKoyebModal={showAddKoyebModal}
        setShowAddKoyebModal={setShowAddKoyebModal}
        newKoyebName={newKoyebName}
        setNewKoyebName={setNewKoyebName}
        newKoyebToken={newKoyebToken}
        setNewKoyebToken={setNewKoyebToken}
        koyebAddAccountError={koyebAddAccountError}
        addKoyebAccount={addKoyebAccount}
        koyebAddingAccount={koyebAddingAccount}
      />

      <AddFlyAccountDialog
        showAddFlyModal={showAddFlyModal}
        setShowAddFlyModal={setShowAddFlyModal}
        newFlyName={newFlyName}
        setNewFlyName={setNewFlyName}
        newFlyToken={newFlyToken}
        setNewFlyToken={setNewFlyToken}
        flyAddAccountError={flyAddAccountError}
        addFlyAccount={addFlyAccount}
        flyAddingAccount={flyAddingAccount}
      />

      <KoyebConfigDialog
        koyebConfigTarget={koyebConfigTarget}
        setKoyebConfigTarget={setKoyebConfigTarget}
        koyebConfigForm={koyebConfigForm}
        setKoyebConfigForm={setKoyebConfigForm}
        koyebConfigError={koyebConfigError}
        saveKoyebConfig={saveKoyebConfig}
        koyebConfigSaving={koyebConfigSaving}
      />

      <KoyebDeploymentsDialog
        koyebDeployTarget={koyebDeployTarget}
        setKoyebDeployTarget={setKoyebDeployTarget}
        openKoyebDeployments={openKoyebDeployments}
        koyebDeployLoading={koyebDeployLoading}
        koyebDeployError={koyebDeployError}
        koyebDeployments={koyebDeployments}
        getKoyebStatusTone={getKoyebStatusTone}
        getKoyebStatusText={getKoyebStatusText}
        cancelKoyebDeployment={cancelKoyebDeployment}
      />

      <KoyebScaleDialog
        koyebScaleTarget={koyebScaleTarget}
        setKoyebScaleTarget={setKoyebScaleTarget}
        koyebScaleScope={koyebScaleScope}
        setKoyebScaleScope={setKoyebScaleScope}
        koyebScaleInstances={koyebScaleInstances}
        setKoyebScaleInstances={setKoyebScaleInstances}
        koyebScaleError={koyebScaleError}
        resetKoyebScale={resetKoyebScale}
        saveKoyebScale={saveKoyebScale}
        koyebScaleSaving={koyebScaleSaving}
      />

      <KoyebDomainsDialog
        koyebDomainsTarget={koyebDomainsTarget}
        setKoyebDomainsTarget={setKoyebDomainsTarget}
        koyebNewDomain={koyebNewDomain}
        setKoyebNewDomain={setKoyebNewDomain}
        addKoyebDomain={addKoyebDomain}
        koyebDomainsLoading={koyebDomainsLoading}
        koyebDomainsError={koyebDomainsError}
        koyebDomains={koyebDomains}
        getKoyebStatusText={getKoyebStatusText}
        refreshKoyebDomain={refreshKoyebDomain}
        isArmed={isArmed}
        deleteKoyebDomain={deleteKoyebDomain}
      />

      <KoyebSecretsDialog
        koyebSecretsTarget={koyebSecretsTarget}
        setKoyebSecretsTarget={setKoyebSecretsTarget}
        koyebNewSecretName={koyebNewSecretName}
        setKoyebNewSecretName={setKoyebNewSecretName}
        koyebNewSecretValue={koyebNewSecretValue}
        setKoyebNewSecretValue={setKoyebNewSecretValue}
        addKoyebSecret={addKoyebSecret}
        koyebSecretsLoading={koyebSecretsLoading}
        koyebSecretsError={koyebSecretsError}
        koyebSecrets={koyebSecrets}
        updateKoyebSecretValue={updateKoyebSecretValue}
        isArmed={isArmed}
        deleteKoyebSecret={deleteKoyebSecret}
      />

      <KoyebCreateDialog
        koyebCreateTarget={koyebCreateTarget}
        setKoyebCreateTarget={setKoyebCreateTarget}
        koyebCreateForm={koyebCreateForm}
        setKoyebCreateForm={setKoyebCreateForm}
        koyebCatalogInstances={koyebCatalogInstances}
        koyebCatalogRegions={koyebCatalogRegions}
        koyebCreateError={koyebCreateError}
        createKoyebService={createKoyebService}
        koyebCreateSaving={koyebCreateSaving}
      />

      <KoyebUsageDialog
        koyebUsageTarget={koyebUsageTarget}
        setKoyebUsageTarget={setKoyebUsageTarget}
        openKoyebUsage={openKoyebUsage}
        koyebUsageLoading={koyebUsageLoading}
        koyebUsageError={koyebUsageError}
        koyebUsageData={koyebUsageData}
      />
